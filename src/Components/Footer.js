        ...
        <div class="container py-5">
          <div class="row g-5">
            <div class="col-lg-4 col-md-6">
              ...
              <p class="mb-2">
                <i class="fa fa-map-marker-alt me-3"></i>At- Hutupara, Darlipali
                Sundargarh Odisha - 770072
              </p>
              <p class="mb-2">
                <i class="fa fa-phone-alt me-3"></i>+91 9673454330
              </p>
              <p class="mb-2">
                <i class="fa fa-envelope me-3"></i>info@blueswanpublicschool.in
              </p>
